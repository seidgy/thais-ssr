  ...
  <div id="main-home">
    <div class="search-box">
      ...
      <div class="search-form">
        ...
        <h2 class="search-form__subtitle">Onde você quer morar</h2>
        <form class="search-form__form">
          <div class="search-bar">
            <input type="hidden" v-model="finalidade">
            <input type="text" v-model="textoBusca" class="search-bar__input" @focus="hideHints()" @blur="addPlaceholder()" id="search">
            <span class="search-bar__hints" id="hints"></span>
            <button v-on:click.prevent="$router.push({ name: 'imoveis', query: { textoBusca: textoBusca, tipo: tipo, finalidadeImovel: finalidade } })" class="search-bar__button">
              <svg xmlns="http://www.w3.org/2000/svg" width="16.171" height="16.188"><g data-name="Grupo 861"><path data-name="Caminho 5" d="M11.559 1.978a6.775 6.775 0 10-.906 10.341l3.528 3.528a1.167 1.167 0 001.651-1.651l-3.528-3.544a6.764 6.764 0 00-.745-8.674zm-1.521 8.059a4.623 4.623 0 110-6.538 4.61 4.61 0 010 6.539z" fill="#fff"/></g></svg>
            </button>
          </div>
  ...
  mounted(){
    new Typed('#hints', {
      strings: [
        ...
        'apartamento 2 quartos no guará',
        'kitnet na asa sul com 2 banheiros',
        'apartamento de 3 quartos asa norte'
      ],
      typeSpeed: 45,
      backSpeed: 20,
      startDelay: 2000,
